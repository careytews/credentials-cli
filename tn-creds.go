...
var options struct {
	...
	TokenFile           string `short:"t" long:"token" description:"Name of token file" default:".tn-auth"`
	Bucket              string `short:"b" long:"bucket" description:"Name of credentials bucket" default:"trust-networks-credentials"`
	...
	Project         string `short:"p" long:"project" description:"Project ID hosting credential services (CKMS and pub/sub)" default:"trust-networks"`
